...
Route::post('/register/admin', [UserController::class, 'registerAdmin'])->name('admin.register.submit');

// Route::post('/admin/login', [UserController::class, 'loginAdmin'])->name('admin.login.submit');
// Route::get('/admin/login', [UserController::class, 'showLoginForm'])->name('admin.login');
Route::post('/admin/dashboard', [UserController::class, 'showAdminDashboard'])->name('admin.dashboard');
